...
export default function CapabilityDetail() {
  ...
  if (!data) {
    return (
      <div style={{ background: '#05050e', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <p style={{ color: '#dadada', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', sans-serif" }}>{capabilityDetailConfig.notFoundText || 'Not found.'}</p>
      </div>
    );
  }
  ...
  return (
    <div style={{ background: '#05050e', minHeight: '100vh', position: 'relative', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        {/* Hero */}
        <section style={{ padding: isMobile ? 'clamp(70px, 14vw, 120px) 4vw clamp(30px, 6vw, 60px)' : 'clamp(80px, 15vw, 180px) 5vw clamp(40px, 8vw, 100px)', maxWidth: 860, margin: '0 auto' }}>
          ...
          <h1
            style={{
              ...
              fontWeight: 400,
              fontSize: isMobile ? 'clamp(28px, 7vw, 42px)' : 'clamp(40px, 5vw, 72px)',
              lineHeight: 1.1,
        ...
        {/* Article body */}
        <article style={{ padding: isMobile ? '48px 4vw' : '80px 5vw', maxWidth: 860, margin: '0 auto' }}>
          {data.paragraphs.map((p, i) => (
            <p
              ...
              style={{
                ...
                lineHeight: 1.9,
                color: '#dadada',
                marginBottom: i < data.paragraphs.length - 1 ? (isMobile ? 24 : 32) : 0,
              }}
            >
              {p}
            </p>
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: isMobile ? '0 4vw 80px' : '0 5vw 120px' }}>
