    ...
    >
      <div
        ...
        style={{
          ...
          maxHeight: isMobile ? '100vh' : '64vh',
          background: 'linear-gradient(160deg, rgba(26, 22, 56, 0.97), rgba(10, 10, 26, 0.98))',
          border: isMobile ? 'none' : '1px solid rgba(150, 170, 255, 0.24)',
        ...
        <div className="flex items-center" style={{ padding: '16px 20px', borderBottom: '1px solid rgba(150,170,255,0.14)', gap: 12 }}>
          ...
          <input
            ...
            style={{
              ...
              fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', sans-serif", fontSize: 15, color: '#eceaf8',
            }}
          />
          <span style={{ fontFamily: "'SF Mono', Menlo, Consolas, monospace", fontSize: 10, color: 'rgba(160,150,230,0.5)', border: '1px solid rgba(160,150,230,0.3)', borderRadius: 4, padding: '2px 6px' }}>
            ESC
          </span>
        </div>
        <div style={{ overflowY: 'auto' }}>
          {results.length === 0 && (
            <div style={{ padding: '28px 22px', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', sans-serif", fontSize: 13, color: 'rgba(200,196,235,0.6)' }}>
          ...
          {results.map((it, i) => (
            ...
            >
              ...
              <span style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 16, color: '#f0eefc' }}>
                {it.title}
              </span>
              <span style={{ fontFamily: "'SF Mono', Menlo, Consolas, monospace", fontSize: 10, letterSpacing: 1, color: 'rgba(165,150,230,0.6)' }}>
                {it.latin}
              </span>
              <span style={{ marginLeft: 'auto', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'PingFang SC', 'Microsoft YaHei', sans-serif", fontSize: 11, color: 'rgba(180,200,255,0.5)' }}>
